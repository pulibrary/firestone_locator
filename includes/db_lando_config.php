...
define("BASE_URL", "http://localhost:32807/"); // Needed for CAS, should reflect full correct url

$dbconnects["stage"] = new mysqli($hostname_Locator, $username_Locator, $password_Locator, 'locator_stage');
/* check connection */
if ($dbconnects["stage"]->connect_errno) {
	printf("Connect failed: %s\n", $dbconnects["stage"]->connect_error);
	exit();
}
// $dbconnects["live"] = new mysqli($hostname_Locator, $username_Locator, $password_Locator, 'locator_live');
// if ($dbconnects["live"]->connect_errno) {
// 	printf("Connect failed: %s\n", $dbconnects["live"]->connect_error);
// 	exit();
// }
$dbconnects["production"] = new mysqli($hostname_Locator_production, $username_Locator, $password_Locator, 'locator_production');
